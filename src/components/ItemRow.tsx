  ...
  return (
    <div className="rounded-xl border border-gray-100 bg-gray-50 p-3 flex flex-col gap-2">
      <div className="flex gap-2 items-center">
        <input
          className="flex-1 min-w-0 rounded-lg border border-gray-200 px-2 py-1 text-sm outline-none focus:border-indigo-400"
      ...
      <div className="relative flex items-center">
        ...
        <input
          ...
          inputMode="numeric"
          min={0}
          className="w-full rounded-lg border border-gray-200 pl-7 pr-3 py-1 text-sm outline-none focus:border-indigo-400"
          placeholder="0"
